...
test.describe("Shift Types API", () => {
  ...
  test.describe("POST /api/admin/shift-types", () => {
    test("should create new shift type with valid data", async ({
      page,
      request,
    }) => {
      ...
      expect(data.description).toBe(
        "Assists with kitchen preparation and cleanup"
      );
    ...
    test("should handle optional description field", async ({
      page,
      request,
    }) => {
      await loginAsAdmin(page);
  ...
  test.describe("GET /api/admin/shift-types", () => {
    test("should return list of shift types for admin", async ({
      page,
      request,
    }) => {
      await loginAsAdmin(page);
