...
export function MigrationRegistrationForm({ user, token }: MigrationRegistrationFormProps) {
  ...
  const validateStep = (step: number): boolean => {
    switch (step) {
      ...
      case 1: // Emergency contact
        return !!(formData.emergencyContactName && formData.emergencyContactRelationship && formData.emergencyContactPhone);
      case 2: // Security
        return !!(formData.password && formData.confirmPassword && formData.password === formData.confirmPassword && formData.password.length >= 8);
      case 3: // Agreements
        return formData.volunteerAgreementAccepted && formData.healthSafetyPolicyAccepted;
      default:
        return false;
    }
  };
          ...
          {currentStep === 0 && (
            <div className="space-y-4">
              <Alert>
                ...
                <AlertDescription>
                  We've pre-filled your information from the previous system. Please review and update as needed.
                </AlertDescription>
              </Alert>
          ...
          {currentStep === 2 && (
            <div className="space-y-4">
              <Alert>
                ...
                <AlertDescription>
                  Create a secure password for your new account. Your password must be at least 8 characters long.
                </AlertDescription>
              </Alert>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => updateFormData("volunteerAgreementAccepted", checked)}
                    required
                  />
                  <Label htmlFor="volunteerAgreement" className="text-sm leading-relaxed">
                    I agree to the volunteer terms and conditions, and understand my responsibilities as an Everybody Eats volunteer. *
                  </Label>
                </div>
                ...
                <div className="flex items-start space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => updateFormData("healthSafetyPolicyAccepted", checked)}
                    required
                  />
                  <Label htmlFor="healthSafetyPolicy" className="text-sm leading-relaxed">
                    I have read and agree to follow the health and safety policies. *
                  </Label>
                </div>
                ...
                <div className="flex items-start space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => updateFormData("emailNewsletterSubscription", checked)}
                  />
                  <Label htmlFor="emailNewsletter" className="text-sm leading-relaxed">
                    I would like to receive email newsletters and updates about volunteer opportunities.
                  </Label>
                </div>
                ...
                <div className="flex items-start space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => updateFormData("willingToProvideReference", checked)}
                  />
                  <Label htmlFor="willingToProvideReference" className="text-sm leading-relaxed">
