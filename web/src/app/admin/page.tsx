    ...
    <PageContainer testid="admin-dashboard-page">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card
          ...
          className={pendingSignups > 0 ? "border-orange-200 bg-orange-50" : ""}
        >
          <CardHeader className="pb-2">
          ...
          <CardContent>
            {nextShift ? (
              <div className="space-y-2">
                ...
                >
                  <Link href={`/admin/shifts?upcoming=true`}>View Details</Link>
                </Button>
              </div>
            ) : (
              <p
          ...
          <CardContent>
            {lowSignupShifts.length > 0 ? (
              <div className="space-y-3">
                ...
                {lowSignupShifts.slice(0, 2).map((shift: ShiftWithSignups) => {
                  const confirmedCount = shift.signups.length;
                  const fillRate =
                    shift.capacity > 0
