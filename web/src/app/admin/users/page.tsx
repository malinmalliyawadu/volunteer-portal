  ...
  return (
    <PageContainer testId="admin-users-page">
      <PageHeader
          ...
          actions={
            <InviteUserDialog>
              <Button size="sm" className="btn-primary gap-2" data-testid="invite-user-button">
        ...
        <section className="mb-8" data-testid="stats-section">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 sm:gap-6" data-testid="user-stats-grid">
              <Card className="shadow-md border-slate-200 bg-white/80 backdrop-blur-sm hover:shadow-lg transition-all duration-300" data-testid="total-users-stat">
                <CardContent className="p-4 sm:p-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent" data-testid="total-users-count">{totalUsers}</div>
              ...
              <Card className="shadow-md border-slate-200 bg-white/80 backdrop-blur-sm hover:shadow-lg transition-all duration-300" data-testid="volunteers-stat">
                <CardContent className="p-4 sm:p-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent" data-testid="volunteers-count">
                        {totalVolunteers}
                      </div>
                      <div className="text-sm text-slate-600 font-medium">
                        Volunteers
              ...
              <Card className="shadow-md border-slate-200 bg-white/80 backdrop-blur-sm hover:shadow-lg transition-all duration-300" data-testid="admins-stat">
                <CardContent className="p-4 sm:p-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent" data-testid="admins-count">{totalAdmins}</div>
                      <div className="text-sm text-slate-600 font-medium">
                        Admins
                      </div>
                    </div>
              ...
              <Card className="shadow-md border-slate-200 bg-white/80 backdrop-blur-sm hover:shadow-lg transition-all duration-300" data-testid="new-users-stat">
                <CardContent className="p-4 sm:p-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent" data-testid="new-users-count">
                        {newUsersThisMonth}
                      </div>
                      <div className="text-sm text-slate-600 font-medium">
                        New This Month
                  ...
                  <div className="flex gap-2" data-testid="role-filter-buttons">
                    ...
                    >
                      <Button
                        ...
                        size="sm"
                        className={!roleFilter ? "btn-primary shadow-sm" : "hover:bg-slate-50"}
                    ...
                    >
                      <Button
                        ...
                        size="sm"
                        className={
                          roleFilter === "VOLUNTEER" ? "btn-primary shadow-sm" : "hover:bg-slate-50"
                        }
                    ...
                    >
                      <Button
                        ...
                        size="sm"
                        className={roleFilter === "ADMIN" ? "btn-primary shadow-sm" : "hover:bg-slate-50"}
        ...
        <section data-testid="users-section">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div className="flex items-center gap-3">
              ...
              {(searchQuery || roleFilter) && (
                <Badge variant="outline" className="bg-gradient-to-r from-slate-50 to-gray-50 text-slate-700 border-slate-200 font-medium">
                      ...
                      <div className="flex items-center gap-4 flex-1">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1">
                            <h3 className="font-semibold text-lg text-slate-900 truncate" data-testid={`user-name-${user.id}`}>
                              {getDisplayName(user)}
                            </h3>
                            <Badge
                              variant="outline"
                          ...
                          <div className="flex flex-wrap items-center gap-3 sm:gap-4 text-sm text-slate-600">
                            <div className="flex items-center gap-1.5">
                              ...
                              <span className="truncate font-medium" data-testid={`user-email-${user.id}`}>{user.email}</span>
                            </div>
                            {user.phone && (
                              <div className="flex items-center gap-1.5">
                        ...
                        <div className="hidden sm:flex items-center gap-6 text-sm">
                          <div className="text-center">
                            <div className="text-2xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent" data-testid={`user-shifts-count-${user.id}`}>
                              {user._count.signups}
                            </div>
                            <div className="text-slate-500 font-medium">Shifts</div>
                          </div>
                        </div>
                      </div>
