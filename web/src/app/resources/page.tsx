...
import { BookOpen, FileText, Video, Link2, Image, Headphones } from "lucide-react";
import Link from "next/link";

export const metadata: Metadata = {
  title: "Resources - Everybody Eats Volunteer Portal",
  description: "Access helpful resources, training materials, and guides for volunteers",
};
...
export default async function ResourcesPage({ searchParams }: ResourcePageProps) {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Access training materials, guides, videos, and helpful resources to enhance your volunteer experience
          </p>
        </div>
        ...
        {!searchParams.category && !searchParams.type && !searchParams.search && (
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-gray-900 mb-6">Browse by Type</h2>
                  ...
                  <Card className="hover:shadow-md transition-shadow cursor-pointer h-full">
                    ...
                    <CardContent>
                      <p className="text-sm text-gray-500">
                        {category._count.resources} resource{category._count.resources !== 1 ? 's' : ''}
                      </p>
                    </CardContent>
                  </Card>
                </Link>
