...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-50 bg-black/80 transition-all duration-200 ease-out",
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "data-[state=closed]:opacity-0 data-[state=closed]:scale-95 data-[state=closed]:translate-y-[-48%]",
