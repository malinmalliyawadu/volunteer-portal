    ...
    >
      <AnimatePresence mode="popLayout">
        ...
        const gradeCount = {
          ...
          green: shift.signups.filter((s) => s.user.volunteerGrade === "GREEN")
            .length,
                        ...
                        return (
                          ...
                          >
                            <Link
                              ...
                              className="h-9 w-9 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 border-2 border-white flex items-center justify-center shadow-md flex-shrink-0 hover:shadow-lg transition-shadow"
                            >
                              <span className="text-xs font-bold text-white">
                                {(signup.user.name ||
                                  signup.user.firstName)?.[0]?.toUpperCase()}
                              </span>
                            </Link>
